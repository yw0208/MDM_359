...
def get_opt(opt_path, device):
    ...
    if opt.dataset_name == 't2m':
        ...
        opt.dim_pose = 251
        opt.max_motion_length = 196
    elif opt.dataset_name == 'trumans':
        opt.data_root = '/opt/data/private/datasets/trumans'
        opt.motion_dir = pjoin(opt.data_root, 'new_joint_vecs_w_rh')
        opt.text_dir = pjoin(opt.data_root, 'new_texts')
        opt.joints_num = 22
        opt.dim_pose = 359
        opt.max_motion_length = 196
    else:
