...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='trumans', choices=['humanml', 'kit', 'humanact12', 'uestc', 'trumans'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", default="save/my_humanml_trans_enc_512_2", type=str,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml', 'trumans']:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
